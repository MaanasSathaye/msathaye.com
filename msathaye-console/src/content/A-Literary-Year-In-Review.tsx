  ...
  return (
    <div className='content-section'>
      ...
      <a
        ...
        rel='noopener noreferrer'
      >
        <img src={phm} alt='Project Hail Mary Book Cover' className='book-cover' />
      </a>
      <h3>
      ...
      <a
        ...
        rel='noopener noreferrer'
      >
        <img src={tsatt} alt='The Spy and The Traitor Book Cover' className='book-cover' />
      </a>
      <h3>
        Cold War. Espionage. Family ties. Political chess. Hot extractions. I recommend the book if
      ...
      <a
        ...
        rel='noopener noreferrer'
      >
        <img src={iig} alt='Writing an Interpreter in Go Book Cover' className='book-cover' />
      </a>
      <h3>
      ...
      <h3>
        ...
        reference news media statistics, which could probably (maybe easily?) be replaced with some
        double blind, RCTs.
      </h3>
      ...
      <a
        ...
        rel='noopener noreferrer'
      >
        <img src={sg} alt='The Sports Gene Book Cover' style={{ width: '250px', height: 'auto' }} />
      </a>
      ...
      <h3>Fairness in sport is harder than you think.</h3>
    </div>
  )
}
