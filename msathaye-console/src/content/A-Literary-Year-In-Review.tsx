...
const ALYIR = () => {
  return (
    <div className='page'>
      ...
      >
        <img src={behave} alt='Behave Book Cover' style={{ width: '250px', height: 'auto' }} />
      </a>
      <body>
      ...
      <body>Remember what I said about science communication? Yeah, this one is excellent.</body>
      <br></br>
      ...
      <body>Fairness in sport is harder than you think.</body>
    </div>
  )
}
