  ...
  return (
    <div className='page'>
      ...
      <ul>
        ...
        <li>Chemistry</li>
        <li>
          <a href='https://www.chess.com/member/mawnisss' target='_blank' rel='noopener noreferrer'>
            Chess
          </a>{' '}
          and{' '}
      ...
      <body>
        ...
        Golang, PostgreSQL, Terraform, and Typescript React; the former involves lots of Python and
        Airflow.
      </body>
    </div>
  )
